      ...
      requests.push(
        filteredCampaignScope
          ? fetchSearchedCollection(
            ...
            requestedCampaignName
              ? buildSelectedCampaignActivitySearchBody(
                HUBSPOT_TASK_BASE_PROPERTIES,
                requestedCampaignName,
                plan.tasks,
                ["hs_task_subject", "hs_task_body", "hs_task_campaign_guid", "hs_campaign", "campanhas", "utm_campaign"],
              )
              : buildCampaignActivitySearchBody(
                HUBSPOT_TASK_BASE_PROPERTIES,
                plan.tasks,
                ["hs_task_subject", "hs_task_body", "hs_task_campaign_guid", "hs_campaign", "campanhas"],
              ),
            plan.tasks,
          ).catch(() => [])
      ...
      requests.push(
        filteredCampaignScope
          ? fetchSearchedCollection(
            ...
            requestedCampaignName
              ? buildSelectedCampaignActivitySearchBody(
                HUBSPOT_CALL_BASE_PROPERTIES,
                requestedCampaignName,
                plan.calls,
                ["hs_call_title", "hs_call_body", "hs_campaign_guid", "hs_campaign", "campanhas", "utm_campaign"],
              )
              : buildCampaignActivitySearchBody(
                HUBSPOT_CALL_BASE_PROPERTIES,
                plan.calls,
                ["hs_call_title", "hs_call_body", "hs_campaign_guid", "hs_campaign", "campanhas"],
              ),
            plan.calls,
          ).catch(() => [])
      ...
      requests.push(
        filteredCampaignScope
          ? fetchSearchedCollection(
            ...
            requestedCampaignName
              ? buildSelectedCampaignActivitySearchBody(
                HUBSPOT_MEETING_BASE_PROPERTIES,
                requestedCampaignName,
                plan.meetings,
                ["hs_meeting_title", "hs_meeting_body", "hs_internal_meeting_notes", "hs_campaign_guid", "hs_campaign", "campanhas"],
              )
              : buildCampaignActivitySearchBody(
                HUBSPOT_MEETING_BASE_PROPERTIES,
                plan.meetings,
                ["hs_meeting_title", "hs_meeting_body", "hs_internal_meeting_notes", "hs_campaign_guid", "hs_campaign"],
              ),
            plan.meetings,
          ).catch(() => [])
