...
export const globalSearchIndex = [
  {
    ...
    keywords: "kpi métricas metas forecast receita relatório pipeline",
    route: "/relatorios",
  },
  {
    id: "sellers",
  ...
  },
  {
    ...
    keywords: "pre vendedor pre-vendedor pre sales prospecção conexão contato reuniao agenda qualificação sdr",
  ...
  },
  {
    ...
    keywords: "campanhas campaign sdr prospecção mql sql reunioes fechamento licitacao",
    route: "/campanhas",
  },
  {
    id: "tasks",
    ...
    keywords: "tarefas reuniões chamadas call meeting agenda hubspot follow-up vendedor",
    route: "/tarefas",
  },
  {
    id: "ai",
    ...
    keywords: "nora ia ai análise sistema risco insight diagnóstico",
    route: "/ai-agent",
  },
  {
    id: "settings",
    ...
    keywords: "configurações hubspot notificações preferência conta",
    route: "/configuracoes",
  },
  {
    id: "profile",
    ...
    keywords: "perfil conta usuário acesso foto",
    route: "/perfil",
  },
  {
    id: "notifications",
