# Documentacao Sales Ops Backup

Este diretorio concentra a documentacao tecnica e de produto do sistema.
...
7. [Supabase, Migrations e RLS](SUPABASE-MIGRATIONS-E-RLS.md)
...
Atualizar este pacote sempre que houver mudancas em:
